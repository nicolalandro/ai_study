...
checkpoint = ModelCheckpoint('./ai/weights.{epoch:03d}-{val_acc:.4f}.hdf5', monitor='val_acc', verbose=1,
...
print("Save Model...")
with open('./ai/vocaabulary_inv.json', 'w') as outfile:
    json.dump(vocabulary_inv, outfile)
# serialize model to JSON
model_json = model.to_json()
with open("./ai/model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("./ai/model.h5")
